...
{
    class ApplicationLifecycleTool;
    class SceneHierarchyTool;
...
namespace gladius
{
    ...
    class ApplicationMCPAdapter : public MCPApplicationInterface
    {
      private:
        ...
        // Utility)
        std::unique_ptr<mcp::tools::ApplicationLifecycleTool> m_lifecycleTool;
        std::unique_ptr<mcp::tools::SceneHierarchyTool> m_sceneHierarchyTool;
