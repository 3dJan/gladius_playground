...
typedef CNANOVDB_ALIGNED_STRUCT(CNANOVDB_DATA_ALIGNMENT)
{
    ...
    cnanovdb_map mMap;   // 264B. affine transformation between index and world space in both single
...
/**/
#else
#define DEFINE_KEY(KEY) cnanovdb_coord KEY;
...
#define CREATE_ROOTDATA(VALUETYPE, STATSTYPE, SUFFIX)                                              \
    ...
    {                                                                                              \
        ...
        if (tile->child == 0)                                                                      \
            return tile->value;                                                                    \
        return cnanovdb_node2##SUFFIX##_getValue(                                                  \
          cnanovdb_rootdata##SUFFIX##_getChild(rootdata, tile), ijk);                              \
    }                                                                                              \
                                                                                                   \
    ...
    {                                                                                              \
        ...
        if (tile->child == 0)                                                                      \
            return tile->state;                                                                    \
        return cnanovdb_node2##SUFFIX##_isActive(                                                  \
          cnanovdb_rootdata##SUFFIX##_getChild(rootdata, tile), ijk);                              \
    }                                                                                              \
                                                                                                   \
