...
{
    /**
     * @brief Owns the uniform, storage, and map-readable staging buffers for one slice dispatch.
     */
    class WebGPUBufferSet
    {
      public:
        ...
        void writeUniforms(wgpu::Queue const & queue, SliceUniforms const & uniforms) const;
